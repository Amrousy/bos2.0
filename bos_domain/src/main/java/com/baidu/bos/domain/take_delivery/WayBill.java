...
public class WayBill implements Serializable {
	...
	public String toString() {
		return "WayBill [id=" + id + ", wayBillNum=" + wayBillNum + ", order=" + order + ", sendName=" + sendName
				+ ", sendMobile=" + sendMobile + ", sendCompany=" + sendCompany + ", sendArea=" + sendArea
				+ ", sendAddress=" + sendAddress + ", recName=" + recName + ", recMobile=" + recMobile + ", recCompany="
				+ recCompany + ", recArea=" + recArea + ", recAddress=" + recAddress + ", sendProNum=" + sendProNum
